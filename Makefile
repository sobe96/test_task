...
kirch.o: kirch.c
	$(CC) -std=c99 -O0 -g -Wall -c -o kirch.o kirch.c

print_kirch.o: print_kirch.c
	$(CC) -std=c99 -O0 -g -Wall -c -o print_kirch.o print_kirch.c

trusty_reflection.o: trusty_reflection.c
	$(CC) -std=c99 -O0 -g -Wall -c -o trusty_reflection.o trusty_reflection.c
